...
import com.gmail.tracebachi.deltaredis.shared.redis.RedisConnectionManager;
 ...
 */
public interface DeltaRedisPlugin {
    /**
    ...
    /**
     * @return {@link Channel#PROXY} or the name of the Spigot server
     * <p>This value is set in the configuration file for each server.</p>
     */
