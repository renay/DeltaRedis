...
import static com.gmail.tracebachi.deltaredis.shared.structure.SplitPatterns.COMMA;

/**
 * Created by Trace Bachi (tracebachi@gmail.com, BigBossZee) on 4/28/16.
 */
public class RunCmdCommand extends Command implements Listener, PluginSource {
